...
export const getIncidents = async (): Promise<IIncident[]> => {
  ...
  try {
    ...
    const filteredIncidents = incidents.filter(
      (incident) =>
        (incident.form && incident.form.recruitmentProcessId === currentRecruitmentId) ||
        (incident.formResponse &&
          incident.formResponse.formId &&
          incident.formResponse.formId.recruitmentProcessId === currentRecruitmentId)
    );
