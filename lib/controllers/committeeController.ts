...
export const createCommittee = async (committeeData: Partial<ICommittee>): Promise<ICommittee | null> => {
    await dbConnect();
    try {
...
export const updateCommittee = async (id: string, updates: Partial<ICommittee>): Promise<ICommittee | null> => {
    await dbConnect();
    try {
